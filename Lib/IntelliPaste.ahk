...
#Include <uriDecode>
#Include <SharePoint>
; Calls: Connections_Link2Text
;#Include <Connections> conditional include
#Include <Confluence>
#Include <Clip>
...
If Jira_IsUrl(sLink) {
	linktext := Jira_Url2IssueKey(sLink)
	If !linktext
		return linktext
}
...
If FileExist("Lib/Connections.ahk") {
	FunStr := "Connections_IsWinActive"
	If (%FunStr%())
		useico := True
	Else
