/* 
 ...
 About: 
            o v2.0 by HotKeyIt  https://autohotkey.com/board/topic/44872-function-showtooltip-20
 */ 
...
/* 
 Function:  TooltipTimeout 
            Show the tooltip and automatically dismiss it after a timeout. 

 Parameters: 
            Text  - Text to show. If omitted or empty, any existing tooltip will be hidden. 
            Out   - Time in milliseconds for tooltip to show and to disappear. 
                  - If TimeOut is 0, tooltip will never be dismissed. Optional.  
            Nr    - Tooltip number, by default 19. Multiple tooltips can exist with different settings. 

 About: 
            o v2.0 by HotKeyIt  https://autohotkey.com/board/topic/44872-function-showtooltip-20 - extracted from ShowTooltip
 */ 

ToolTipTimeout(Text="",Out=1500, Nr=19){ 

ShowTooltip(Text,,,0,Out,,Nr)
